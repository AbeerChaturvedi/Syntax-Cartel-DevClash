...
const PRESETS = [
  { id: 'lehman_2008', label: '2008 Lehman', emoji: '🏦', desc: 'Credit contagion, interbank freeze', color: '#ef4444' },
  { id: 'covid_2020', label: '2020 COVID', emoji: '🦠', desc: 'Liquidity crisis, VIX spike to 82', color: '#f97316' },
  { id: 'svb_2023', label: '2023 SVB', emoji: '🏚️', desc: 'Regional bank run, rate shock', color: '#eab308' },
  { id: 'flash_crash', label: 'Flash Crash', emoji: '⚡', desc: 'HFT liquidity vacuum, 6-min drop', color: '#a855f7' },
];
    ...
    return (
      <div className="stress-test-wrapper">
        <div className="stress-test-active-row">
          ...
          >
            ⚠️ {preset ? `${preset.emoji} ${preset.label}` : 'CRISIS'} ACTIVE
          </motion.button>
          <button
